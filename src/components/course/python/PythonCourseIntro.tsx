  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="p-6 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border border-blue-100">
        <h2 className="text-2xl font-semibold mb-4">Welcome to Python Programming</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 bg-card rounded-lg border text-center">
            ...
            <p className="text-xl font-medium">12 weeks</p>
          </div>
          <div className="p-4 bg-card rounded-lg border text-center">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-green-500" />
              <span>Ask any Python question and get immediate answers</span>
            </li>
          </ul>
        </div>
      </div>
