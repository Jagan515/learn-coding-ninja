...
import CppCourseIntro from "@/components/course/cpp/CppCourseIntro";
import LearningPath from "@/components/course/cpp/LearningPath";
import CppMCQ from "@/components/course/cpp/CppMCQ";
import CodingChallenge from "@/components/course/cpp/CodingChallenge";
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-lg text-muted-foreground mt-2">
                  Master modern C++ from fundamentals to advanced concepts
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              <ChatInterface 
                courseContext={{
                  title: "C++ Programming",
                  description: "AI-powered assistant for C++ learning",
