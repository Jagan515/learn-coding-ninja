...
import DSACourseIntro from "@/components/course/dsa/DSACourseIntro";
import LearningPath from "@/components/course/dsa/LearningPath";
import DSAMCQ from "@/components/course/dsa/DSAMCQ";
import CodingChallenge from "@/components/course/dsa/CodingChallenge";
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-lg text-muted-foreground mt-2">
                  Master essential DSA concepts with implementation in multiple languages
                </p>
              </div>
            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <ChatInterface 
                courseContext={{
                  ...
                  description: "AI-powered assistant for DSA learning",
